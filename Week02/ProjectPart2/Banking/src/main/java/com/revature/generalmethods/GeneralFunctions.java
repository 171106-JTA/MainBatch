 ...
 * 
 */
package com.revature.generalmethods;
...
//		baseCustomers.add(new Customer( ++(new Banking().nbOfCustomers), name, address, email, phone, ssn, new GeneralFunctions<>().reverseFormatDate(dob), 
//				new Date(), userName, password, 1, false));
//		
//		//Serializes and reload the file
//		new GeneralFunctions<Customer>().serialize(baseCustomers, "customers.ser");		
//		return true;
//	}
//
...
//			}
//		}
//		new GeneralFunctions<Transaction>().serialize(baseTransactions, "transactions.ser");	
//		new GeneralFunctions<Account>().serialize(baseAccounts, "accounts.ser");	
//		return balance;
//
//	
//	
