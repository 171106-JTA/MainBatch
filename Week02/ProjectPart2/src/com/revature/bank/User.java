...
public class User implements Serializable {
	...
	private final boolean HASH_PASSWORDS = false;
	...
	public User(String name, String pass, Accounts accounts, String state)
	{
		...
		_name = name;
		_pass = (HASH_PASSWORDS) ? User.hashString(pass) : pass;
		// ...now, let's instantiate everything else...
		_accounts = accounts;
		// ideally, we would have initialized state, but let's pass on that for now.
		_state = state;		
		// use the default id of NO_ID
		_userID = NO_ID;
	}
	
	public User(int id, String name, String pass, String state)
	{
		this(name, pass, new Accounts(), state);
		_userID = id;
	}
	...
	public void setPass(String pass) {
		this._pass = HASH_PASSWORDS ? hashString(pass) : pass;
//		this._pass = pass;
