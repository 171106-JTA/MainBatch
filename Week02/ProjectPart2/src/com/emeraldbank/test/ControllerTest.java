...
public class ControllerTest {
	...
	public void userExistsTest() {
		assertTrue(Controller.userExists("Oz")); 
...
//		assertEquals(false, Controller.userExists("user 5")); 	
	...
	@Test
	public void getPortfolioByUserIdTest() {
		System.out.println(Controller.getUserPortfolio("sjgillet"));
		System.out.println(Controller.getUserPortfolio("sjgillet",false,false));
