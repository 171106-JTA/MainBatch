...
public class JDBC {
	...
	private class SQLReaderThread extends Thread {
		...
		@Override
		public void run() {
			DaoImpl.readSQLFiles(UserDaoImpl.class.getSimpleName());
			DaoImpl.readSQLFiles(AdminDaoImpl.class.getSimpleName());
			DaoImpl.readSQLFiles(RequestDaoImpl.class.getSimpleName());
			DaoImpl.readSQLFiles(TransactionDaoImpl.class.getSimpleName());
			DaoImpl.readSQLFiles(LoanDaoImpl.class.getSimpleName());
		}
	}
}
