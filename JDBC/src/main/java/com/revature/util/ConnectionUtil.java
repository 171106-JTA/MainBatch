...
public class ConnectionUtil {
	...
	public static Connection getConnection() throws SQLException {
		 ...
		 * 
		 * set environment vars (how for macs?)
		 * variable name:	anythingIWant
		 * variable value: class;url;username;password  (actual things)
		 * 
		 * then--
	...
	/* 
	 * if oracle driver doesn't work, force it w Class.forName(prop.getProperty("class"));
	 */
}
/*
