 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://ws.revature.com/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
@HandlerChain(file="src/main/resources/handler-chain.xml")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://ws.revature.com/", "HelloWorldService");
    ...
    public IHelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://ws.revature.com/", "HelloWorldPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.revature.com/", "HelloWorldPort"), IHelloWorld.class, features);
    }
