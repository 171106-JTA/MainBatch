...
public class User implements Serializable {
	 ...
	 * @param user - the user of new user
	 * @param pass - the pass of new user
	 */
	 ...
	 *
	 * @param admin - boolean representing admin status
	 */
	 ...
	 *
	 * @param approved - boolean representing approved status
	 */
	...
	public String toString() {
		return "User [name=" + name + ", bal=$" + bal + ", user=" + user + ", approved=" + approved + "]";
	}

	/**
	 * Withdraw.
	 *
	 * @param x - the amount to withdraw
	 * @return true, if successful
	 */
	public boolean withdraw(double x) {
		if (approved) {
			...
			if (testBal < 0) {
				...
				System.err.println("The approval status of '" + name + "' has been revoked due to insufficient funds.");
				approved = false;
				return false;
			}
