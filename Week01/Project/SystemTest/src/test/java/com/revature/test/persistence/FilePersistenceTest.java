...
public class FilePersistenceTest {
	...
	public void shouldCreateNewCheckingAccountWithFieldParams() {
		...
		params.put(Checking.BALANCE, Float.toString(100.0f));
		params.put(Checking.STATUSID, Status.ACTIVE);
		params.put(Checking.TYPEID, customerCheckingAcct.getType());
	...
	public void shouldBeAbleToUpdateExistingCheckingAccountRecordWithBusinessObject() {
		Account data = new Checking(customerId, checkingId, 20.0f, Status.ACTIVE);
		FieldParams cnds = new FieldParams();
		Resultset resultset;
	...
	public void shouldBeAbleToUpdateExistingCheckingAccountWithFieldParams() {
		Account data = new Checking(customerId, checkingId, 1.0f, Status.ACTIVE);
		FieldParams cnds = new FieldParams();
		FieldParams params = new FieldParams();
		Resultset resultset;
		...
		// Set Data 
		cnds.put(Checking.USERID, Long.toString(customerId));
		params.put(Checking.BALANCE, Float.toString(1.0f));
		manager.insert(customerCheckingAcct);
	...
	public void shouldRemoveAllCheckingAccountRecords() {
		...
		// Set data
		manager.insert(customerCheckingAcct);
		manager.insert(new Checking(41181, 512423, 1.0f, Status.ACTIVE));
	...
	public void shouldBeAbleToUpdateExistingCreditAccountRecordWithBusinessObject() {
		Account data = new Credit(customerId, creditId, 20.0f, 100.0f, 1500.0f, Status.ACTIVE);
		FieldParams cnds = new FieldParams();
		Resultset resultset;
	...
	public void shouldBeAbleToUpdateExistingCreditAccountWithFieldParams() {
		Account data = new Credit(customerId, creditId, 1.0f, customerCreditAcct.getInterest(), customerCreditAcct.getCreditLimit(), Status.ACTIVE);
		FieldParams cnds = new FieldParams();
		FieldParams params = new FieldParams();
		Resultset resultset;
	...
	public void shouldRemoveAllCreditAccountRecords() {
		...
		// Set data
		manager.insert(customerCreditAcct);
		manager.insert(new Credit(41181, 512423, 1.0f, 10.0f, 1500.0f, Status.ACTIVE));
