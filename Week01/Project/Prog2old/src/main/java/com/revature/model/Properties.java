...
public class Properties {
	...
	// Connections
	public static final String SERVER_CONN = "Connecting...";
	public static final String SERVER_SHUTDOWN_QUERY = "Enter [Q] to shutdown the server...";
	...
	// ints
	public static final int PORT_ID = 8080;
