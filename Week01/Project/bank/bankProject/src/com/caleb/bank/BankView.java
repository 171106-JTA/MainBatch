...
class BankView {
	 ...
	 * @return
	 */
	public String showUnblockUserScreen(ArrayList<User> activeUsers) {
	...
	public int showUserScreen(User user) {
		...
		if (user.hasLoan()) {
			System.out.println("Your current loan balance is: " + user.getLoanBalance());
		} else {
	...
	public void showPreviousTransactions(User user) {
		ArrayList<String> previousTransactions = user.account.getPreviousTransActions();
	 ...
	 * @return String
	 */
	public String showPromoteScreen(ArrayList<User> usersThatCanBePromoted) {
	 ...
	 * @return String
	 */
	public String showBlockUserScreen(ArrayList<User> activeUsers, String currentAdmin) {
		System.out.println("********** Below are accounts that you can block **********");

		for (User user : activeUsers) {
			if ((!user.account.isBlocked()) && (!user.getEmail().equalsIgnoreCase(currentAdmin))) // make sure user cannot
																								// block themself
				System.out.println(user.toString());
		}
	 ...
	 * @return String
	 */
	public String showApproveAccountsScreen(ArrayList<User> pendingAccounts) {
