...
UPDATE EMPLOYEE SET EMP_CATEGORY=2
WHERE EMPLOYEE_USERNAME='tester2';

ALTER TABLE REIMBURSEMENT_CASE
ADD case_status number(3);

ALTER TABLE REIMBURSEMENT_CASE
ADD Reimbursed_AMT decimal(6,2);
...
SELECT * FROM EMP_CATEGORY;
UPDATE REIMBURSEMENT_CASE SET SUPERVISOR_ID = 21;
commit;
SELECT * FROM REIMBURSEMENT_CASE WHERE CASE_STATUS = 2;
Update REIMBURSEMENT_CASE SET REIMBURSED_AMT = 10.00;
