...
/**
 * Servlet implementation class BenReviewForm
 */
public class BenReviewForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(currForm == null) {
			...
			out.println("<br> <a href='FinalApprove'>Approve Reimbursement</a>");
			out.println("<br> <a href='Deny'>Deny Reimbursement</a>");
			out.println("<br> <a href='AlterRem'> Alter Reimbursement</a>");
			
			out.println("<div align='center'><object width=50% height=50% data='" + currForm.getFileName() + "'></object></div>");
			//out.println("</div>");
		}
		
		out.println("<br> <a href='BenReview'>Back</a>");
	}
