...
/**
 * Servlet implementation class SVPendingRequests
 */
public class SVPendingRequests extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SVPendingRequests() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form action='AddGrade'>"
		...
		out.println("<a href='SVProfile.html'>Back</a>");
	}
